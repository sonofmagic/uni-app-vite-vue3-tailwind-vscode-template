...
function defineAsyncApi(name, fn, protocol, options) {
  return promisify$1(name, wrapperAsyncApi(name, fn, undefined, options));
}
...
class ReactiveEffect {
  ...
  stop() {
    ...
    if (this.active) {
      preCleanupEffect(this);
      postCleanupEffect(this);
      (_a = this.onStop) == null ? undefined : _a.call(this);
      this.active = false;
    }
  }
}
...
function deleteEntry(key) {
  ...
  get2 ? get2.call(target, key) : undefined;
  ...
  if (shouldTrack && activeEffect) {
    ...
    trackEffect(
      ...
      (_a = ref2.dep) != null ? _a : ref2.dep = createDep(
        () => ref2.dep = undefined,
        ref2 instanceof ComputedRefImpl ? ref2 : undefined
      ));
  }
}
...
function doWatch(source, cb, {
  ...
  const reactiveGetter = (source2) => deep === true ? source2 : (
    ...
    traverse(source2, deep === false ? 1 : undefined)
  );
  let getter;
...
function createAppAPI(render, hydrate) {
  return function createApp2(rootComponent, rootProps = null) {
    ...
    const app = context.app = {
      ...
      use(plugin2, ...options) {
        if (installedPlugins.has(plugin2)) ; else if (plugin2 && isFunction(plugin2.install)) {
...
const Pinia = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  get MutationType () { return MutationType; },
  PiniaVuePlugin,
  acceptHMRUpdate,
  createPinia,
  defineStore,
