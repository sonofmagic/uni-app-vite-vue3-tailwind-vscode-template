<template>
  <view class="space-y-1.5 [&>view]:text-center">
    <view
      class="aspect-[100/16.1] bg-[url(https://pic4.zhimg.com/80/v2-63755eaa318858e33445862d72581207.png)] bg-[length:100%_100%] bg-no-repeat"></view>

    <view
      class="flex items-center justify-center text-gray-600/75"
      @click="copy('https://github.com/sonofmagic/weapp-tailwindcss')">
      <view class="i-mdi-github-circle mx-2 text-[32px] text-black"></view>
      <view class="text-[22px]">+</view>
      <view class="i-mdi-star mx-2 text-[32px] text-yellow-400"></view>
    </view>
    <view
    ...
    <view
      class="mb-2 text-center before:text-xs before:text-sky-400 before:content-['现在，让我们开始神奇的_tailwindcss_开发之旅吧！']"></view>
  </view>
</template>
